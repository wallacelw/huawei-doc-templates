...
\setdoctitle{Guide: Getting Started with Huawei Cloud ECS}
...
\begin{changelog}
  ...
  \changelogentry{1.9.0}{\today}{\item Updated to base template v3.0.1 — minor fixes (test auto-discovery, help text, comments, CI).}
  \changelogentry{1.8.0}{\today}{\item Updated to base template v3.0.0 — modular pipeline refactoring (shared Lua filter factory, shared DOCX fix logic, build system auto-discovery).}
