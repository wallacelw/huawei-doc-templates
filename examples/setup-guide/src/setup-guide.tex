...
curl -fsSL https://raw.githubusercontent.com/wallacelw/huawei-doc-templates/main/install.sh | bash
  ...
  interactively (\inlinecode{./install.sh}), it prompts for optional components
...
\begin{table}[H]
  \begin{hutable}{|l|l|l|}
    ...
    Templates update & \inlinecode{git pull \&\& ./install.sh}     & New templates available \\
    Gateway uninstall & \inlinecode{./scripts/uninstall.sh --all}  & Docker stack removed \\
    Templates uninstall & \inlinecode{./uninstall.sh --all}         & Skills + modules removed \\
