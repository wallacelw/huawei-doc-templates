...
python3 templates/_base/adoc_docx_preprocessor.py --template guide --target md src/main.adoc -o /tmp/pre.adoc
...
python3 templates/_base/adoc_docx_preprocessor.py --template guide --target docx src/main.adoc -o /tmp/pre.adoc
asciidoctor -b docbook /tmp/pre.adoc -o /tmp/doc.dbk && pandoc -f docbook --reference-doc=templates/guide/guide-reference.docx /tmp/doc.dbk -o output.docx
python3 templates/guide/create-guide-reference-docx.py --fix --template guide output.docx

# HTML (pre-process → asciidoctor html5)
python3 templates/_base/adoc_docx_preprocessor.py --template guide --target html src/main.adoc -o /tmp/pre.adoc
